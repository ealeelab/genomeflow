...
TETranscript = KubernetesPodOperator (
    namespace = 'singlecore',
    image_pull_policy='Always',
    image='grc.io/synapseDownloader:',
    cmds=["python","test_script.py"],
...
synapseDownloader >> HISAT2Alignment >> [rTEA,L1EM,TELocal,TETranscript] >> end
